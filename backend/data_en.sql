...
INSERT INTO muscles (id, muscle_group_id, name, image) VALUES
                                                    ...
                                                    (13, 3, 'Soleus', ''),
                                                    (14, 3, 'Hamstrings', ''),
                                                    (15, 3, 'Gluteus maximus', ''),
                                                    (16, 3, 'Gluteus medius', ''),
                                                    (17, 3, 'Tibialis anterior', ''),
                                                    (18, 3, 'Gastrocnemius', ''),
                                                    (19, 4, 'Anterior deltoid', ''),
                                                    (20, 4, 'Acromial deltoid', ''),
                                                    (21, 4, 'Posterior deltoid', ''),
                                                    (22, 5, 'Biceps brachii', ''),
                                                    (23, 5, 'Triceps brachii', ''),
                                                    (24, 5, 'Brachialis', ''),
                                                    (25, 5, 'Brachioradialis', ''),
                                                    (26, 6, 'Rectus abdominis', ''),
                                                    (27, 6, 'Obliques', ''),
