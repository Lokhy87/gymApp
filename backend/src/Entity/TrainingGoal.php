...
class TrainingGoal
{
     ...
     */
    #[ORM\OneToMany(targetEntity: WorkPlan::class, mappedBy: 'trainingGoal')]
    ...
    public function removeWorkPlan(WorkPlan $workPlan): static
    {
        if ($this->workPlans->removeElement($workPlan)) {
            ...
            if ($workPlan->getTrainingGoal() === $this) {
                $workPlan->setTrainingGoal(null);
            }
        }
